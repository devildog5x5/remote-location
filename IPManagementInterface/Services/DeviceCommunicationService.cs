...
namespace IPManagementInterface.Services
{
    public class DeviceCommunicationService
    {
        ...
        public async Task<string?> SendRequestAsync(string ipAddress, int port, string protocol, string? path = null, System.Net.Http.HttpMethod? method = null, string? content = null, CancellationToken cancellationToken = default)
        {
            try
            {
